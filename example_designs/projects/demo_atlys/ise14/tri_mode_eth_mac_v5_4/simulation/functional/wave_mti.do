...
add wave -noupdate -format Logic /demo_tb/dut/trimac_fifo_block/rx_mac_aclk
...
add wave -noupdate -format Logic /demo_tb/gmii_tx_clk
...
add wave -noupdate -format Logic /demo_tb/gmii_rx_clk
